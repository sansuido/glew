...
/// --------------------------- GL_EXT_copy_image ---------------------------
/// @nodoc
late Pointer<NativeFunction<Void Function()>> _glCopyImageSubDataExt;
...
void glCopyImageSubDataExt(
    ...
    int srcHeight,
    int srcDepth) {
  final glCopyImageSubDataExtAsFunction = _glCopyImageSubDataExt
      .cast<
          NativeFunction<
              Void Function(
                  Uint32 srcName,
      ...
      .asFunction<
          void Function(
              ...
              int srcHeight,
              int srcDepth)>();
  return glCopyImageSubDataExtAsFunction(
      srcName,
      srcTarget,
      srcLevel,
      srcX,
...
/// @nodoc
void gladLoadGlLoaderExtCopyImage(
    Pointer<NativeFunction<Void Function()>> Function(String) load) {
  _glCopyImageSubDataExt = load('glCopyImageSubDataEXT');
}
