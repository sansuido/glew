...
/// @nodoc
late Pointer<NativeFunction<Void Function()>> _glBlitFramebufferNv;
...
/// ```
void glBlitFramebufferNv(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0,
    int dstY0, int dstX1, int dstY1, int mask, int filter) {
  final glBlitFramebufferNvAsFunction = _glBlitFramebufferNv
      .cast<
          NativeFunction<
              Void Function(
                  Int32 srcX0,
      ...
      .asFunction<
          void Function(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0,
              int dstY0, int dstX1, int dstY1, int mask, int filter)>();
  return glBlitFramebufferNvAsFunction(
      srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}

/// @nodoc
void gladLoadGlLoaderNvFramebufferBlit(
    Pointer<NativeFunction<Void Function()>> Function(String) load) {
  _glBlitFramebufferNv = load('glBlitFramebufferNV');
}
