...
/// @nodoc
late Pointer<NativeFunction<Void Function()>> _glBlitFramebufferAngle;
...
void glBlitFramebufferAngle(int srcX0, int srcY0, int srcX1, int srcY1,
  ...
  final glBlitFramebufferAngleAsFunction = _glBlitFramebufferAngle
      .cast<
          NativeFunction<
              Void Function(
                  Int32 srcX0,
  ...
  return glBlitFramebufferAngleAsFunction(
      srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}

/// @nodoc
void gladLoadGlLoaderAngleFramebufferBlit(
    Pointer<NativeFunction<Void Function()>> Function(String) load) {
  _glBlitFramebufferAngle = load('glBlitFramebufferANGLE');
}
